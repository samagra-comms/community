...
[Backend Setup](development-environment.md#backend-setup)

[Setting up IDE](development-environment.md#setting-up-ide)

[Environment variable setup](development-environment.md#enviroment-variable-setup)

[Debug services](development-environment.md#debug-services)

[Build and Execute UCI](development-environment.md#build-and-execute-uci)

[Testing the API](development-environment.md#testing-the-api)

[Frontend Setup (Admin Console)](development-environment.md#frontend-setup-admin-console)

[Frontend Setup (PWA)](development-environment.md#frontend-setup-pwa)
