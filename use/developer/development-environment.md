...
7. Install IDE ([STS](https://spring.io/tools) / [Eclipse](https://www.eclipse.org/downloads/) / [IntelliJ](https://www.jetbrains.com/idea/download/))
...
5. Add [Enviorment Variable](https://github.com/samagra-comms/community/blob/main/use/docs/environment-variables.md) in IDE.
...
A message will be first received in the inbound service to convert the message to XMessage format then it will be sent to the kafka topic which is being listened by the orchestrator service. To check the build/execution flow of the services [click chere](https://github.com/samagra-comms/community/blob/main/use/docs/build-execution-flow.md).
