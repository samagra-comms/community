...
Similarly the adapter and the outbound service are linked in the following fashion. ![](https://samagra-development.github.io/docs/img/outbound.jpeg)
...
To enable these, we have to add them in ```convertMessageToXMsg``` and convert these according to the [xMessage spec](https://github.com/samagra-comms/community/blob/main/use/developer/uci-basics.md)
